		...
		if(tankStateTime>0){
			...
			switch (tankBullet.getCurBulletState()) {
				...
				case Fired:case InMotion:
					...
					switch (nxtPosObj) {
						case Hero_D:case Hero_L:case Hero_U:case Hero_R:
							tankBullet.setCurBulletState(BulletState.HitTank);
							break;
						case Brick:case Rubber:case Flag:case MBlock:case MMirror_D:case MMirror_L:case MMirror_R:case MMirror_U:case RMirror_D:case RMirror_L:case RMirror_R:case RMirror_U:case Steel:case Villain_D:case Villain_L:case Villain_R:case Villain_U:case OutOfBounds:
