...
public class GridFinderOptions {
	...
	/**
	 * When true, diagonal movement requires both neighbors to be open. When false, diagonal movement can be achieved by having only one open nighbor
	 * <p>
	 * 
	...
	public GridFinderOptions() {
		this(true, true, false, 1, 1.4f);
	}

	public GridFinderOptions(final boolean allowDiagonals, final boolean dontCrossCorners, final boolean isyDown, final float orthogonalMovementCost, final float diagonalMovementCost) {
		allowDiagonal = allowDiagonals;
